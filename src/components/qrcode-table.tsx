...
export default function QRCodeTable({
  ...
  useEffect(() => {
    // hiện tại : thư viện Qr code  nó sẽ vẽ lên cái thẻ canvas
    // bây giờ chúng ta sẽ tạo 1 cái thẻ canvas ảo để thư viện QRcode nó vẽ QR lên đó
    // và chúng ta sẽ edit thẻ canvas thật
    //cuối cùng chúng ta đưa thẻ canvas ảo ở trên vào thẻ canvas thật

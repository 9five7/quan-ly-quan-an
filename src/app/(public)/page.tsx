  ...
  return (
    <div className='w-full space-y-4'>
      <div className='relative'>
        ...
        />
        <div className='z-20 relative text-white py-10 md:py-20 px-4 sm:px-10 md:px-20'>
          <h1 className='text-center  text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold'>Nhà hàng 9five7</h1>
